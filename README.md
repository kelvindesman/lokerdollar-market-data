...
![active roles](https://img.shields.io/badge/active_roles-5%2C600-1f6feb)
![salary disclosure](https://img.shields.io/badge/disclose_salary-16.8%25-orange)
![updated](https://img.shields.io/badge/updated-2026--09--07-2ea043)
...
**5,600 active remote roles paying in USD, from 1,410 companies — and only 16.8% of them will tell you the salary.**
...
> **Last updated: 2026-09-07.** Regenerated weekly from the live [Loker Dollar](https://lokerdollar.com/en?utm_source=github_data_teaser&utm_medium=referral&utm_campaign=market_data_2026_09) corpus. Free sample here; the full enriched dataset is paid.
...
| --- | --- | --- | --- | --- | --- | --- |
| Purpose Fellowship Public Health & Policy… | Voice Up Publishing Incorporated | regional | 20 | 30 | USD | hourly |
| Voice Up Community Health Navigator 100% … | Voice Up Publishing Incorporated | regional | 5600 | 8000 | USD | monthly |
| Voice Up Founding LCSW Team 100% Remote T… | Voice Up Publishing Incorporated | regional | 50 | 50 | USD | hourly |
| Colorado (remote) - Occupational therapist | Presence | regional | 1600 | 1920 | USD | monthly |
| Principal Operations Engineer, Network | Fluidstack | worldwide | 258000 | 300000 | USD | yearly |
...
- **5,600** active remote USD roles tracked right now
- **942** (16.8%) disclose a salary range
- **1,410** distinct hiring companies
- **5.2%** of tracked Indonesian-market roles are tech roles (n=57,987)

## Weekly trend

Week over week: **+501** active roles, salary disclosure **+2.1 pp**.
...
```html
Source: <a href="https://lokerdollar.com/en/data">Loker Dollar Remote Job Market Data</a> (CC BY 4.0), retrieved 2026-09-07.
```
...
@dataset{lokerdollar_remote_job_market,
  ...
  note      = {Version 2026-09-07. CC BY 4.0}
}
```
